...
namespace ötleadó
{
    public partial class Form1 : Form
    {
        ...
        public List<PictureBox> játékos1lapjai = new List<PictureBox>();
        public Form1()
        {
            InitializeComponent();
        }       
        ...
        {
            List<PictureBox> leadottak = new List<PictureBox>()
            {
                pictureBox11, pictureBox12, pictureBox13, pictureBox14, pictureBox15
            };
            List<PictureBox> vizsgáltak = new List<PictureBox>()
            {
                pictureBox16, pictureBox17, pictureBox18, pictureBox19, pictureBox20
            };
            List<PictureBox> melyikeketkell = new List<PictureBox>();
            foreach (var item in vizsgáltak)
            {
                if (item.Image != null)
                {
                    melyikeketkell.Add(item);
                }
            }
            List<PictureBox> játékos2lapjai = new List<PictureBox>()
            {
                pictureBox6, pictureBox7, pictureBox8, pictureBox9, pictureBox10, player_2_pót_1, player_2_pót_2, player_2_pót_3, player_2_pót_4, player_2_pót_5
            };
            foreach (var item in játékos2lapjai)
            {
                if (item.Image == null && melyikeketkell.Count > 0)
                {
                    PictureBox kártya = melyikeketkell[0];
                    item.Image = kártya.Image;
                    item.Tag = kártya.Tag;
                    foreach (var itemm in leadottak)
                    {
                        if (itemm.Image == kártya.Image)
                        {
                            itemm.Image = null;
                        }
                    }
        ...
        private void pictureBox10_Move(object sender, EventArgs e)
        {

        }
        //felvevés előkészítése
        #region
        ...
        {
            pictureBox20.Image = pictureBox15.Image;
        }
        #endregion
    }
}
